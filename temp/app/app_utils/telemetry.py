...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=geap-agents-beta,service.version={commit_sha}",
        )
    ...
    try:
        ...
        logging.warning(
            "Telemetry disabled: no Google Application Default Credentials found "
            "(run `gcloud auth application-default login` to enable Cloud Trace/Logging)"
        )
        return None
