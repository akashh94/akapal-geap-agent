...
def add_header(slide, title_text, category_text="GEAP E*TRADE POC"):
    ...
    cat_box = slide.shapes.add_textbox(
        Inches(0.8), Inches(0.4), Inches(10), Inches(0.3)
    )
...
def create_card(slide, left, top, width, height, title="", border_color=None):
    ...
    if title:
        ...
        tb = slide.shapes.add_textbox(
            left + Inches(0.15), top + Inches(0.1), width - Inches(0.3), Inches(0.4)
        )
        tf = tb.text_frame
        tf.word_wrap = True
        p = tf.paragraphs[0]
...
def main():
    ...
    title_box = slide1.shapes.add_textbox(
        Inches(1.0), Inches(2.2), Inches(11.333), Inches(3.5)
    )
    ...
    line = slide1.shapes.add_shape(
        MSO_SHAPE.RECTANGLE, Inches(1.0), Inches(5.8), Inches(4.5), Inches(0.04)
    )
    line.fill.solid()
    ...
    tb_chall = slide2.shapes.add_textbox(
        Inches(0.95), Inches(2.3), Inches(5.3), Inches(4.0)
    )
    ...
    create_card(
        ...
        Inches(5.6),
        Inches(4.8),
        "THE GEAP POC SOLUTION",
    )
    tb_sol = slide2.shapes.add_textbox(
        Inches(7.05), Inches(2.3), Inches(5.3), Inches(4.0)
    )
    ...
    steps = [
        (
            "1. Input & Scrub",
            "PII Shield",
            "Detects and redacts SSNs, phone numbers, emails, and accounts before LLM transmission.",
        ),
        (
            "2. Intent Routing",
            "Auto-Router",
            "Scores queries using keyword weights & active page bias to assign the best specialist agent.",
        ),
        (
            "3. Context Injection",
            "Context Engine",
            "Appends real-time routes, balances, whitelist sources, and read-only restrictions.",
        ),
        (
            "4. Stream Engine",
            "Gemini 2.0 Flash",
            "Processes requests and handles recursive function-calling loops locally.",
        ),
        (
            "5. Output Guard",
            "Compliance Gate",
            "Appends investment disclaimers, blocks outbound wires, and stages human desk fallbacks.",
        ),
    ]
    ...
    for i, (num_title, label, desc) in enumerate(steps):
        ...
        create_card(
            slide3, left, Inches(2.0), card_width, card_height, num_title, border
        )

        # Details inside card
        tb = slide3.shapes.add_textbox(
            left + Inches(0.1), Inches(2.5), card_width - Inches(0.2), Inches(3.8)
        )
        tf = tb.text_frame
        tf.word_wrap = True
    ...
    create_card(
        ...
        Inches(5.6),
        Inches(4.8),
        "UNIFIED CONTEXT ENGINE (context.js)",
    )
    tb_ctx = slide4.shapes.add_textbox(
        Inches(0.95), Inches(2.3), Inches(5.3), Inches(4.0)
    )
    ...
    create_card(
        ...
        Inches(5.6),
        Inches(4.8),
        "INTENT AUTO-ROUTER (agents.js)",
    )
    tb_rt = slide4.shapes.add_textbox(
        Inches(7.05), Inches(2.3), Inches(5.3), Inches(4.0)
    )
    ...
    agents_data = [
        (
            "Portfolio Analyst 📈",
            "Allocation & Risk",
            "Reviews weights, sector concentration, and suggests rebalancing and tax-loss harvesting candidates.",
        ),
        (
            "Trade Assistant ⚡",
            "Execution & Quotes",
            "Provides quotes, explains limit/stop orders, size risk, and validates buying power.",
        ),
        (
            "Market Research 🔬",
            "Market Intelligence",
            "Reviews macro data, trends, stock comparisons, and fundamentals (P/E, EPS).",
        ),
        (
            "Customer Support 💬",
            "Navigation & FAQ",
            "Answers platform support, transfer methods, documents, and fee structures.",
        ),
        (
            "Super Agent 🔬",
            "MS Research & Alts",
            "Integrates Morgan Stanley Research and alts (crypto/ETFs, gold, private equity).",
        ),
        (
            "Mortgage Agent 🏠",
            "Mortgage & HELOC",
            "Directs Jumbo/Rocket paths and extracts customer location, timelines, and HELOC targets.",
        ),
    ]
    ...
    for i, (name, role, desc) in enumerate(agents_data):
        ...
        tb = slide5.shapes.add_textbox(
            left + Inches(0.15), top + Inches(0.5), w_card - Inches(0.3), Inches(1.6)
        )
        tf = tb.text_frame
        tf.word_wrap = True
    ...
    tb_pii = slide6.shapes.add_textbox(
        Inches(0.95), Inches(2.3), Inches(5.3), Inches(4.0)
    )
    ...
    create_card(
        slide6, Inches(6.9), Inches(1.8), Inches(5.6), Inches(4.8), "DEMONSTRATION RUN"
    )
    tb_demo = slide6.shapes.add_textbox(
        Inches(7.05), Inches(2.3), Inches(5.3), Inches(4.0)
    )
    ...
    create_card(
        ...
        Inches(5.6),
        Inches(4.8),
        "FIDUCIARY DISCLOSURES & UTMA PROTECTION",
    )
    tb_fid = slide7.shapes.add_textbox(
        Inches(0.95), Inches(2.3), Inches(5.3), Inches(4.0)
    )
    ...
    p_utma_desc = tf_fid.add_paragraph()
    ...
    create_card(
        ...
        Inches(5.6),
        Inches(4.8),
        "HIGH-RISK ACTION HANDOFF",
    )
    tb_esc = slide7.shapes.add_textbox(
        Inches(7.05), Inches(2.3), Inches(5.3), Inches(4.0)
    )
    ...
    tb_st = slide8.shapes.add_textbox(
        Inches(0.95), Inches(2.3), Inches(5.3), Inches(4.0)
    )
    ...
    tb_fb = slide8.shapes.add_textbox(
        Inches(7.05), Inches(2.3), Inches(5.3), Inches(4.0)
    )
    ...
    p.text = (
        "Widescreen analytics console showing real-time agent metrics and controls:"
    )
    p.font.name = "Outfit"
    p.font.size = Pt(13)
    p.font.color.rgb = TEXT_WHITE
    ...
    tb_stack = slide9.shapes.add_textbox(
        Inches(0.95), Inches(2.3), Inches(5.3), Inches(4.0)
    )
    ...
    create_card(
        slide9, Inches(6.9), Inches(1.8), Inches(5.6), Inches(4.8), "TEST COVERAGE"
    )
    tb_test = slide9.shapes.add_textbox(
        Inches(7.05), Inches(2.3), Inches(5.3), Inches(4.0)
    )
    ...
    tb_res = slide10.shapes.add_textbox(
        Inches(0.95), Inches(2.3), Inches(5.3), Inches(4.0)
    )
    ...
    tb_ns = slide10.shapes.add_textbox(
        Inches(7.05), Inches(2.3), Inches(5.3), Inches(4.0)
    )
    ...
    output_path = (
        ...
        / "docs"
        / "GEAP_Executive_Presentation.pptx"
    )
